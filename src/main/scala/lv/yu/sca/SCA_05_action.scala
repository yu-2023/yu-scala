 ...
 *
 * Scala program     SCA_05_action.scala     Apache License 2.0
 *
...
//  SCA_05_action demonstrates Scala Action in Scala Frame
final class SCA_05_action {
...
//------------------------------
    ...
    val title = "SCALA -- SCA_05_action -- v. 2023.12.12"
 ...
 * @param args[]
 */
object SCA_05_action {

def main(args: Array[String]): Unit = {
                                        SwingUtilities.invokeLater( () => { new SCA_05_action } )
}  //  end main

}  //  end object SCA_05_action
