 ...
 *
 * Scala program     SCA_04_menu_wrap.scala     Apache License 2.0
 *
...
//  SCA_04_menu_wrap demonstrates Scala Menu Wrap in Scala Frame
final class SCA_04_menu_wrap {
...
//------------------------------
    ...
    val title = "SCALA -- SCA_04_menu_wrap -- v. 2023.12.12"
...
}  //  end class SCA_04_menu_wrap

//------------------------------

/**
 * SCALA SCA_04_menu_wrap
 *
 * @param args[]
 */
object SCA_04_menu_wrap {

def main(args: Array[String]): Unit = {
                                        SwingUtilities.invokeLater( () => { new SCA_04_menu_wrap } )
}  //  end main

}  //  end object SCA_04_menu_wrap
